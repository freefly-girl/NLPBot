...
class GPT:
    ...
    def get_responses(self, inputs, params):
...
if __name__ == '__main__':
    ...
    inputs = [
        {'speaker': 0, 'text': 'Посоветуй фильм посмотреть'},
        {'speaker': 1, 'text': 'Фильм называется "Конец света"'},
        {'speaker': 0, 'text': 'Никогда не слышал о нем. Это о чем?'},
    ]
    print(gpt.get_responses(inputs=inputs, params=params_default))